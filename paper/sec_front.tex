...
the held-out ranking with Spearman correlation $\rho=0.996992$ and identifies the best
path. Its symmetric tensor representation is verified to transform covariantly under
nonorthogonal changes of error coordinates.

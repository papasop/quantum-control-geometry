...
The complete v1.3 pipeline freezes the cohort, transverse bases, preconditioners, and
Krawczyk radius, excludes runtime metadata from hashed proof objects, and produces
byte-identical certificates in two complete runs; every ordinary held-out floating-point
outcome is also verified to lie inside its formal ball as an integrity diagnostic. A clean
external reproduction from tag \texttt{v0.3.1} (commit
...
ranking prospectively ($\rho=0.996992$); this evidence is an application of the same
structure, not a premise of the theorem.
